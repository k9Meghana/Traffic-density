...
1.Connect VCC to 5v on arduino and ground pin to GND.
2.Connect IR sensor to arduino board.
3.Connect Ultrasonic sensor to Arduino and specify the pins.
4.Connect LCD display and LED’s to Arduino.
5.After connecting all the sensors to arduino, write  a C or C++ code in the code block.
